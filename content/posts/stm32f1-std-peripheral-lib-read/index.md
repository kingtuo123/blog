...
#include <stdint.h>                         // 包含标准整数类型
    ...
    #define __NVIC_PRIO_BITS    4           // NVIC 优先级寄存器实际有多少位可用，大多数 STM32F1 系列有 4 位（16级）
#endif
...
// SCB CPUID 寄存器定义
#define SCB_CPUID_IMPLEMENTER_Pos          24                                          // 厂商 ID 位置 IMPLEMENTER Position
#define SCB_CPUID_IMPLEMENTER_Msk          (0xFFul << SCB_CPUID_IMPLEMENTER_Pos)       // 掩码
#define SCB_CPUID_VARIANT_Pos              20                                          // 版本号位置 VARIANT Position
#define SCB_CPUID_VARIANT_Msk              (0xFul << SCB_CPUID_VARIANT_Pos)
#define SCB_CPUID_PARTNO_Pos                4                                          // 部件号位置 PARTNO Position
#define SCB_CPUID_PARTNO_Msk               (0xFFFul << SCB_CPUID_PARTNO_Pos)
#define SCB_CPUID_REVISION_Pos              0                                          // 修订号位置 REVISION Position
#define SCB_CPUID_REVISION_Msk             (0xFul << SCB_CPUID_REVISION_Pos)

// SCB 中断控制状态寄存器定义
#define SCB_ICSR_NMIPENDSET_Pos            31                                          // NMI 挂起设置位 NMIPENDSET Position 
#define SCB_ICSR_NMIPENDSET_Msk            (1ul << SCB_ICSR_NMIPENDSET_Pos)

#define SCB_ICSR_PENDSVSET_Pos             28                                          // PendSV 设置位 PENDSVSET Position
#define SCB_ICSR_PENDSVSET_Msk             (1ul << SCB_ICSR_PENDSVSET_Pos)

#define SCB_ICSR_PENDSVCLR_Pos             27                                          // PendSV 清除位 PENDSVCLR Position
#define SCB_ICSR_PENDSVCLR_Msk             (1ul << SCB_ICSR_PENDSVCLR_Pos)

#define SCB_ICSR_PENDSTSET_Pos             26                                          // Pend SysTick 挂起设置位 PENDSTSET Position
#define SCB_ICSR_PENDSTSET_Msk             (1ul << SCB_ICSR_PENDSTSET_Pos)

#define SCB_ICSR_PENDSTCLR_Pos             25                                          // Pend SysTick 挂起清除位 PENDSTCLR Position 
#define SCB_ICSR_PENDSTCLR_Msk             (1ul << SCB_ICSR_PENDSTCLR_Pos)

#define SCB_ICSR_ISRPREEMPT_Pos            23                                          // ISR 抢占位 ISRPREEMPT Position
#define SCB_ICSR_ISRPREEMPT_Msk            (1ul << SCB_ICSR_ISRPREEMPT_Pos)

#define SCB_ICSR_ISRPENDING_Pos            22                                          // ISR 挂起位 ISRPENDING Position
#define SCB_ICSR_ISRPENDING_Msk            (1ul << SCB_ICSR_ISRPENDING_Pos)

#define SCB_ICSR_VECTPENDING_Pos           12                                          // 挂起向量位 VECTPENDING Position
#define SCB_ICSR_VECTPENDING_Msk           (0x1FFul << SCB_ICSR_VECTPENDING_Pos)

#define SCB_ICSR_RETTOBASE_Pos             11                                          // 返回到基址位RETTOBASE Position
