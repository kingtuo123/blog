...
{{< bar title="/var/db/repos/localrepo/metadata/layout.conf" >}}
...
{{< bar title="/etc/portage/repos.conf/localrepo.conf" >}}
...
{{< bar title="/etc/portage/repos.conf/eselect-repo.conf" >}}
...
{{< bar title="/var/db/repos/localrepo/app-misc/hello/hello-1.0.ebuild" >}}
